...
import com.liuzi.mail.MailService;
import com.liuzi.mail.Mail;
...
public class MailServiceImpl implements MailService{
	...
	public void send(String subject, String mailBody, String senderNickName, String receiveUser, 
		...
		Mail.send(subject, mailBody, senderNickName, receiveUser, ccReceiveUser, bccReceiveUser, isHtmlFormat);
	}
	...
	public void sendByTemp(String subject, String receiveUser, String path,
		...
		Mail.sendByTemp(subject, receiveUser, path, map);
	}

	@Override
	public void sendByTemp(String subject, String receiveUser, String path, 
			VelocityContext vc){
		Mail.sendByTemp(subject, receiveUser, path, vc);
	}
}
