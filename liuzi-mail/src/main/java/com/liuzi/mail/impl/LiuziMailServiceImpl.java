...
import com.liuzi.mail.LiuziMailService;
import com.liuzi.mail.LiuziMail;


@Service("liuziMailService")
public class LiuziMailServiceImpl implements LiuziMailService{
	...
	public void send(String subject, String mailBody, String senderNickName, String receiveUser, 
		...
		LiuziMail.send(subject, mailBody, senderNickName, receiveUser, ccReceiveUser, bccReceiveUser, isHtmlFormat);
	}
	...
	public void sendByTemp(String subject, String receiveUser, String path,
		...
		LiuziMail.sendByTemp(subject, receiveUser, path, map);
	}

	@Override
	public void sendByTemp(String subject, String receiveUser, String path, 
			VelocityContext vc){
		LiuziMail.sendByTemp(subject, receiveUser, path, vc);
	}
}
