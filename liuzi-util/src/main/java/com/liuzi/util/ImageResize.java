...
public class ImageResize {
	...
	public static void main(String[] args) {
		String url = "C:/Users/Administrator/Desktop/01.jpg";
		System.out.println(normalResize(url));
	}
	...
	private static Map<String, Object> resize_object(String url, int width){
		...
		String newName = System.currentTimeMillis() + RandomUtil.random_eng(6) + "." + format;
